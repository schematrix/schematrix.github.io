...
(function () {
  ...
  const translations = {
    ...
    en: {
      ...
      wai_man_p: "Schematrix has a manifesto — the \"why\" behind all of this.",
    ...
    tr: {
      ...
      wai_meta: "Burak Bozkurt — Schematrix'in kurucusu. Gündüz gömülü test mühendisi, gece donanım hacker'ı.",
      wai_label: "İnsan Datasheet'i",
      wai_sub: "Tek insan, iki firmware: gündüzleri araba farlarına eziyet ediyorum, geceleri oturup kendi devrelerimi kuruyorum.",
      wai_spec1_l: "Konum",
      wai_spec2_l: "Gündüz İşi",
      wai_spec2_v: "Otomotivde gömülü yazılım testi",
      wai_spec3_l: "Gece İşi",
      wai_spec3_v: "Kurucu, mühendis, çaycı — hepsi @ Schematrix",
      wai_spec4_l: "Arayüzler",
      wai_spec5_l: "Güç Kaynağı",
      wai_spec5_v: "Kahve (günde en az 3 fincan)",
      wai_spec6_l: "Firmware",
      wai_spec6_v: "Merak — her gün güncelleniyor",
      wai_tl_label: "Changelog",
      wai_tl_heading: "Sürüm Geçmişi",
      wai_tl_sub: "Bu insanın büyük sürümleri, sırasıyla.",
      wai_tl1_y: "v0.1 · 1990'lar",
      wai_tl1_t: "İlk commit",
      wai_tl1_d: "Bursa'da açıldım: %100 organik donanım, dokümantasyon yok denecek kadar az. Zaten bütün iyi evrenler böyle başlar — küçücük, gürültülü ve bir anda genişleyen.",
      wai_tl2_y: "v0.4 · ortaokul",
      wai_tl2_t: "Garanti: iptal",
      wai_tl2_d: "Evde ne kadar kumanda varsa \"içinde ne var acaba\" diye söktüm. Geri toplayabildiklerim aşağı yukarı %60. Artan vidalar nereye aitti, hâlâ bilmiyorum.",
      wai_tl3_y: "v0.5 · ergenlik",
      wai_tl3_t: "Kararsız sürüm",
      wai_tl3_d: "Hormon sürücüleri bir gecede kendiliğinden yüklendi. Ses bir kalın bir ince çıkıyor, saçlar kafasına göre takılıyor. O dönemin loglarını açıp bakmıyoruz; \"tanımsız davranış\" deyip geçiyoruz.",
      wai_tl4_y: "v0.6 · lise",
      wai_tl4_t: "Fizik hilesi açıldı",
      wai_tl4_d: "Matematikle fiziğin aslında gerçek dünyanın hile kodları olduğunu burada çaktım. Rotayı elektrona kırdım — yolda birkaç sigorta feda oldu tabii.",
      wai_tl5_y: "v0.7 · ilk aşklar",
      wai_tl5_t: "Eşleşme denemeleri",
      wai_tl5_d: "Birkaç bağlantı kuruldu, hepsi eninde sonunda zaman aşımına uğradı. El sıkışma protokolü, ansızın kopan hatlar ve kimseye %100 uptime sözü vermemek üzerine epey ders çıktı.",
      wai_tl6_y: "v0.9 · felsefe dönemi",
      wai_tl6_t: "Varoluşsal kernel panic",
      wai_tl6_d: "Bir dönem elime ne geçtiyse okudum — kozmoloji, biyoloji, felsefe. Adamakıllı bir ontolojik bunalıma girdim; çıkmak için oturup bir kitap yazdım. Vardığım sonuç şu: kocaman gürültülü bir \"an\" ve üstüne birkaç milyar yıl süren sabırlı bir refactor, bu changelog'un tamamını açıklıyor — dışarıdan bir proje yöneticisine hiç gerek kalmadan. O dönemin bazı build'leri bol alkolle derlendi; hepsini sonradan deprecate ettik, merak etmeyin.",
      wai_tl7_y: "v1.0 · üniversite",
      wai_tl7_t: "Havya edinildi",
      wai_tl7_d: "Üniversitede Elektrik-Elektronik'e başladım. İlk havya yanığı, ilk sabahlama, ilk \"çalışıyor ama neden çalıştığını bilmiyorum\" anı — hepsi burada.",
      wai_tl8_y: "v1.2 · yan görev",
      wai_tl8_t: "Minik hacker'lara hocalık",
      wai_tl8_d: "Altı ay çocuklara robotik ve kodlama öğrettim. En zor soruları onlar sordu; bozma hızlarına hiçbir test düzeneği yetişemedi.",
      wai_tl9_y: "v1.4 · stajlar",
      wai_tl9_t: "Sanayiyle ilk temas",
      wai_tl9_d: "Önce bir elektrik dağıtım şirketinde, sonra bir otomotiv Ar-Ge'sinde staj — derken elektrik-elektronik mühendisi olarak mezun oldum.",
      wai_tl10_y: "v1.5 · askerlik",
      wai_tl10_t: "Zorunlu sistem güncellemesi",
      wai_tl10_d: "Askerlik: sonsuza kadar erteleyemediğin tek güncelleme. Disiplin öğrendim, saçları sıfıra vurdum ve \"koş... şimdi bekle\" protokolünün evrensel olduğunu bizzat doğruladım.",
      wai_tl11_y: "v2.0 · gündüz işi",
      wai_tl11_t: "Profesyonel far kırıcı",
      wai_tl11_d: "Tier-1 bir otomotiv tedarikçisinde gömülü yazılım test mühendisi olarak işe girdim. HiL düzenekleri, CAPL script'leri ve aynı anda 9 OEM programı — hepsi otoyolda selam verdiğin markalar.",
      wai_tl12_y: "v2.x · şimdi",
      wai_tl12_t: "Schematrix: gece vardiyası",
      wai_tl12_d: "Geceler ve hafta sonları bir stüdyoya dönüştü: Meschy, yapay zekâlı bir kamera, bu site — ve büyümeye devam eden bir prototip yığını.",
      wai_sk_label: "Alet Çantası",
      wai_sk_heading: "Yetenek Ağı",
      wai_sk_sub: "Aynı mesh, farklı düğümler. Birine tıkla:",
      wai_sk_hint: "Yukarıdan bir düğüme tıkla.",
      wai_sk1_d: "Gündüz işimin ana dili — Vector HiL düzeneklerinde koşan otomatik CAN/LIN test script'leri.",
      wai_sk2_d: "Araç ağları ve diagnostik — bus dilini ana dilim gibi konuşuyorum.",
      wai_sk3_d: "Hardware-in-the-loop: araba yolda gittiğini sanıyor ama aslında masamda duruyor.",
      wai_sk4_d: "CAPL script'inden bare-metal firmware'e — ne gerekiyorsa.",
      wai_sk5_d: "Şema, dizgi, taze lehim kokusu — Meschy'nin kartı burada doğdu.",
      wai_sk6_d: "Uzun menzil, şebeke yok, dert yok. Meschy'nin oyun alanı.",
      wai_sk7_d: "Görü işi cihazın kendi üstünde: yüz tanıma da yerel LLM de — bulut yok, abonelik yok.",
      wai_sk8_d: "Test düzeneğinden kamera beynine kadar her şeyin yapıştırıcısı.",
      wai_sk9_d: "Süreç disiplini: gereksinim, izlenebilirlik, SWE.4–6. Birinin yapması lazım, o biri benim.",
      wai_man_p: "Schematrix'in bir manifestosu var — bütün bunların \"neden\"i orada.",
      char_caught_1: "Tamam tamam, yakalandım! 🖐",
      char_caught_2: "İyi, madem öyle — kahve molası. ☕",
      char_caught_3: "Helal, hızlıymışsın. 🏃",
      char_caught_4: "Peki, anlaştık. Kıpırdamıyorum... şimdilik."
    }
  };
